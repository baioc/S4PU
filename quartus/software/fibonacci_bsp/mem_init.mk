...
RESET_ADDRESS ?= 0x00024000

#-------------------------------------
# Pre-Initialized Memory Descriptions
#-------------------------------------

# Memory: onchip_mem_nios2
MEM_0 := integration_onchip_mem_nios2
$(MEM_0)_NAME := onchip_mem_nios2
...
$(MEM_0)_START := 0x00024000
$(MEM_0)_END := 0x000267ff
$(MEM_0)_HIERARCHICAL_PATH := onchip_mem_nios2
$(MEM_0)_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: onchip_mem_nios2
onchip_mem_nios2: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
